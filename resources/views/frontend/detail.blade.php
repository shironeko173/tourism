...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <h2>{{ $item->nama_tempat }}</h2>
                        <p>{{ $item->deskripsi }}</p>
                        <div class="testimonial-author">Located: {{ $item->lokasi }}</div>
                ...
                <div class="col-lg-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{ $item->gambar }}" style="width:635px; height:410px" alt="alternative">
    ...
    <div id="contact" class="form-2">
        <div class="container">
            ...
            <div class="row">
                @foreach ($result as $item)
                    <iframe width="100%" height="500" src="https://maps.google.com/maps?q={{$item->lat}},{{$item->long}}&output=embed"></iframe>
                @endforeach
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div> <!-- end of form-2 -->
